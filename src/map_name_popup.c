...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_EPINEIO_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEB] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEC] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTED] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEF] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEG] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEH] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEI] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEJ] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEK] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEL] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEM] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEO] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEP] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTER] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTES] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTET] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEQ] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEU] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEV] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEW] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEX] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTEZ] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SPIKEBLUFF] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_CRYSTALINE_COAST] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_DEV_SHORTCUT_HUB] = MAPPOPUP_THEME_BRICK
};
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_ROUTEA] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEB] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEC] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTED] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEF] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEG] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEH] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEI] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEJ] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEK] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEL] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEM] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEO] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEP] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTER] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTES] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTET] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEQ] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEU] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEV] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEW] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEX] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTEZ] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SPIKEBLUFF] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CRYSTALINE_COAST] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_DEV_SHORTCUT_HUB] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_EPINEIO_CITY] = MAPPOPUP_THEME_BW_DEFAULT
