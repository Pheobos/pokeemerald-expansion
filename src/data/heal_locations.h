static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 13, 26},
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 13, 26},
    [HEAL_LOCATION_OLDALE_TOWN - 1] = {MAP_GROUP(OLDALE_TOWN), MAP_NUM(OLDALE_TOWN), 7, 30},
    ...
    [HEAL_LOCATION_LITTLEROOT_OUTSKIRTS - 1] = {MAP_GROUP(LITTLEROOT_OUTSKIRTS), MAP_NUM(LITTLEROOT_OUTSKIRTS), 19, 54},
    [HEAL_LOCATION_EPINEIO_CITY - 1] = {MAP_GROUP(EPINEIO_CITY), MAP_NUM(EPINEIO_CITY), 20, 25},
};
