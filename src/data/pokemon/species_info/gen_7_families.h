...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_ROWLET] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_SNIPER, ABILITY_LONG_REACH },
    ...
    [SPECIES_LITTEN] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_INTIMIDATE, ABILITY_FUR_COAT },
    ...
    [SPECIES_POPPLIO] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_PUNK_ROCK, ABILITY_LIQUID_VOICE },
