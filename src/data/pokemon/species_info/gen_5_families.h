...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_TEPIG] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_SHEER_FORCE, ABILITY_THICK_FAT },
    ...
    [SPECIES_EMBOAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_SHEER_FORCE, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
    ...
    [SPECIES_SAMUROTT_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TORRENT, ABILITY_DEFIANT, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Samurott"),
        .cryId = CRY_SAMUROTT,
        .natDexNum = NATIONAL_DEX_SAMUROTT,
